rule all_dip3d:
    input:
        ...
        "analysis_other/dip3d/T2T06/1-falign/porec.fragments.bam",
        # Note: ASHIC 3D structure prediction has been moved to structure3d.smk
        # Use rule all_structure3d for 3D prediction with multiple tools
