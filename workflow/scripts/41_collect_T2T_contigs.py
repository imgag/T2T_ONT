...
def main():
    ...
    if all_results:
        ...
        with open(args.output, 'w') as f:
            f.write("sample\tcontig\tchromosome\tcontig_length\tgap_length\tref_length\tmotif_length\tn_gaps\ttotal_gap_length_bed\tmean_gap_size\tmax_gap_size\tmin_gap_size\tgap_density\n")
